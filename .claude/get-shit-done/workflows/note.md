...
- **Global scope**: `/Users/alessiopagliarulo/Documents/Claude Projects/Logisitics Project/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alessiopagliarulo/Documents/Claude Projects/Logisitics Project/.claude/notes/`)
...
2. Glob `/Users/alessiopagliarulo/Documents/Claude Projects/Logisitics Project/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alessiopagliarulo/Documents/Claude Projects/Logisitics Project/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alessiopagliarulo/Documents/Claude Projects/Logisitics Project/.claude/notes/` — works in any directory
