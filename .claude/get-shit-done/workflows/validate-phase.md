...
```
Task(
  prompt="Read /Users/alessiopagliarulo/Documents/Claude Projects/Logisitics Project/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/alessiopagliarulo/Documents/Claude Projects/Logisitics Project/.claude/get-shit-done/templates/VALIDATION.md`
