...
```bash
node "/Users/alessiopagliarulo/Documents/Claude Projects/Logisitics Project/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/alessiopagliarulo/Documents/Claude Projects/Logisitics Project/.claude/get-shit-done/templates/retrospective.md`.
